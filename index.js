...
function get20s(array){
  ...
  for(let i = 0; i < array.length; i++){
    let numstring = parseInt(array[i]['years'])
    if(numstring >= 1900){
...
function addArtist(array){
    const newartist = {
      ...
      "bio": "Garrett Yien (; 25 August 1994 - current day) started Lambda School in June 2021 and is looking forward to a career in web development. ", 
    }
